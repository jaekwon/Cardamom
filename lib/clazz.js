...
(function() {
  ...
  extendProto = function(protoProto) {
    ...
    for (name in protoProto) {
      ...
      _results.push((function(name, value) {
        var desc, getter, setter, _ref, _ref1, _ref2;
        if (name[name.length - 1] === '$' && name.length > 1) {
          name = name.slice(0, name.length - 1);
          if (typeof value === 'function') {
            desc = {
            ...
            setter = value.set;
            desc = value;
            if ((_ref = desc.enumerable) == null) {
              desc.enumerable = true;
            }
            if ((_ref1 = desc.configurable) == null) {
              desc.configurable = true;
            }
            if (desc.value != null) {
              if ((_ref2 = desc.writable) == null) {
                desc.writable = true;
              }
            } else {
              desc.get = function() {
  ...
  this.clazz = function(name, base, protoFn) {
    var clazzDefined, constructor, key, proto, protoCtor, protoProto, value, _ref, _ref1;
    if (typeof name !== 'string') {
      _ref = [void 0, name, base], name = _ref[0], base = _ref[1], protoFn = _ref[2];
    }
    if (protoFn === void 0) {
      _ref1 = [name, void 0, base], name = _ref1[0], base = _ref1[1], protoFn = _ref1[2];
    }
    ...
    if (!(name != null)) {
      constructor = function() {
        ...
        if (this instanceof constructor) {
          ...
          if ((_ref2 = proto.init) != null) {
            _ref2.apply(this, arguments);
          }
          if (this._newOverride !== void 0) {
            return this._newOverride;
          }
          return this;
        } else {
