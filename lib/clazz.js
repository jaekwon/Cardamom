(function() {
  var SUPERKEY, bindMethods, ctor, extendProto, isPropertyDescriptor, _, _getThis, _makeSuper,
  ...
  this.clazz.extend = function(proto, protoProto) {
    return extendProto.call(proto, protoProto);
  };
