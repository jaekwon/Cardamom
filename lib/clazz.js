(function() {
  ...
  extendProto = function(baseProto, childProtoProto) {
    var method, name, value, _ref, _ref2, _results;
    ...
    for (name in childProtoProto) {
      ...
      if (isPropertyDescriptor(value)) {
        if (value.enumerable == null) {
          value.enumerable = (_ref = value["enum"]) != null ? _ref : true;
        }
        if (value.configurable == null) {
          value.configurable = (_ref2 = value.conf) != null ? _ref2 : true;
        }
        ...
        _results.push(Object.defineProperty(constructor.prototype, name, value));
      } else {
        _results.push(void 0);
      }
    }
